...
import { TrendPrediction } from "./trend-prediction"
    ...
    <div className="p-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {/* Trend Analysis & Next Year Prediction */}
          {result.timeSeries && result.timeSeries.length > 2 && (
            <Card className="card">
              <h2 className="text-xl font-bold text-foreground mb-6">Trend Analysis & Next Year Prediction</h2>
              <TrendPrediction data={result.timeSeries} />
            </Card>
          )}
        </div>
